        ...
        <div class="container">
            <div class="row">
                <div class="p-5 text-center">
                    ...
                    <p class="fs-5">
                        Halaman ini akan menampilkan course dan program yang tersedia pada lembaga Bright Excellent
                        English yang terdpaat 3 course yaitu Bahasa Inggris, Komputer, dan Bimbel yang masing masing
                        course memilki program atau kelas yang berbeda.
                    </p>
                </div>
            </div>
        </div>
